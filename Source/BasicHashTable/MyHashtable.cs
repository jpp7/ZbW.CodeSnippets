...
public class MyHashtable
{
    ...
    ///     Wenn der Schlüssel bereits existiert, wird der zugehörige Wert aktualisiert; andernfalls wird ein neues Paar
    ///     hinzugefügt.
    /// </summary>
    /// <param name="key">
    ///     Der Schlüssel vom Typ <c>string</c>, der verwendet wird, um den Wert zu speichern oder zu
    ///     aktualisieren.
    /// </param>
    ...
    /// <returns>
    ///     Der Wert vom Typ <c>string</c>, der dem Schlüssel zugeordnet ist, oder <c>null</c>, wenn der Schlüssel nicht
    ///     gefunden wird.
    /// </returns>
